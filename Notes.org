...
**** TODO Do some more detailed profilling
...
**** DONE Validate 2014 10-year spinup.
     CLOSED: [2022-04-13 Wed 13:59]
**** TODO Run a control 10-year 2014-2018 CROCO-only simulation
** Experiment table
| Name   | Description
...
have done the trick and fixed this.
...
This will be a CROCO-WRF 1/12-degree simulation initialized from
PAC12_75 CROCO-only run
** To-do list:
**** TODO Run a control 5-year 2014-2018 CROCO-WRF simulation
** Procedure
