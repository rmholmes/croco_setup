...
This is an ERA5 forced 1/12-degree simulation over the same PAC12
domain with increased vertical resolution and SODA 3.4.2 lateral
boundary conditions.
** To-do list:
...
effecively MOM5 (ocean sea-ice version of CM2.5) forced with ERA
Interim and assimilation T-S profiles and satellite SSH/SST.

ERA-5 is used for surface forcing (citation?).
...
**** TODO Run a no current feedback simulation?
**** TODO LOAD BALANCING - optimize
...
| Name   | Description
| exp01  | 2014 year 1
| exp02  | 2015-2018 production Control run
| exp03  | 2014+ smooth SST run (Gaussian longitude filter).
| exp04  | As for exp03 except initialized from end of PAC12_75_exp08.
** Performance/scaling:
...
to croco_rst_20131231_exp08end.nc and linked croco_rst_Y2014M01.nc to
that file instead.
...
* Analysis 
** to-do list:
*** DONE Nino 3.4 time series (seasonal and deseasoned)
    CLOSED: [2022-05-20 Fri 12:02]
*** DONE Snapshots of filtered SST, shflx etc. anomalies
    CLOSED: [2022-05-25 Wed 15:53]
*** DONE Other time series (TIWKE, TIWTVAR, domain-integrated wind work)
    CLOSED: [2022-06-10 Fri 15:58]
*** TODO coupling coefficients (TC analysis)
*** TODO heat, zonal momentum and TIWKE budgets
*** TODO Temperature variance budgets (TIWTV)?
*** TODO Wavenumber spectra (take code from NumMix paper).
*** TODO PP81: Vertical structure later years
** Sequence for Toulouse:
*** Validation (CROCO and CROCO-WRF):
**** DONE Global scalars
     CLOSED: [2022-06-15 Wed 02:06]
**** DONE Nino 3.4 time series
     CLOSED: [2022-06-15 Wed 02:06]
**** DONE SST, SSS and SSH biases (mean and seasonal cycles along equator).
     CLOSED: [2022-06-15 Wed 02:06]
**** DONE TIWEKE and variance
     CLOSED: [2022-06-15 Wed 18:54]
**** DONE Vertical structure along equator.
     CLOSED: [2022-06-15 Wed 18:54]
*** Smooth-SST CROCO-WRF
**** DONE Nino 3.4 - focus on end of 2016.
     CLOSED: [2022-06-15 Wed 18:53]
**** DONE Surface variable and heat flux snapshots
     CLOSED: [2022-06-15 Wed 18:54]
**** DONE TIW temperature variance and velocity variance
     CLOSED: [2022-06-15 Wed 18:54]
**** DONE Meridional heat flux (just surface, or with depth)?
     CLOSED: [2022-06-15 Wed 18:54]
**** TODO Wavenumber spectra?
**** TODO T-lat space budgets?
**** TODO Some indication of vertical mixing changes?
*** PP81 experiment:
**** TODO Mean surface state changes
**** TODO Vertical structure changes
**** TODO Modulation TIW changes
