...
run
** To-do list:
**** TODO Rerun noTWB and noMesoscaleCFB simulations with masked smoothing.
...
| exp02  | 2015-2018 production Control run (started from PAC12_75, exp10end)
...
| exp12  | As for exp03 but with tanh-masked smoothing
| exp13  | As for exp07 but with tanh-masked smoothing
