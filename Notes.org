...
| exp02  | 2015-2018 Control run                           | DONE
| exp03  | 2014+ smooth SST run, started from exp10end     | DELETED
| exp04  | exp03 E2: initialized from exp8end              | DELETED
| exp05  | PP81 mixing, started from exp10end. TIW-output  | RUNNING 2015+... -0
| exp06  | NoCFB, started from exp10end.                   | DONE
| exp07  | NoMesoCFB, started from exp10end.               | DELETED
| exp08  | Control E2, initialized from exp8end.           | DONE
| exp09  | Control E3, initialized from exp9end. TIW-output| RERUNNING 2015+ with TIW-output -12.
...
| exp14  | exp12 E2, initialized from exp8end.             | RUNNING 2015+ -3
| exp15  | exp13 E2, initialized from exp8end.             | started 2014-2015 -4
| exp16  | exp06 E2, initialized from exp8end.             | started 2014-2015 -5
| exp17  | exp12 E3, initialized from exp9end. TIW-output  | RUNNING 2015+ -6
| exp18  | exp13 E3, initialized from exp9end. TIW-output  | started 2014-2015 -7 - Add TIW-output
| exp19  | exp06 E3, initialized from exp9end. TIW-output  | started 2014-2015 -8 - Add TIW-output
| exp20  | exp12 E4, initialized from exp7end.             | started 2014-2015 -9
| exp21  | exp13 E4, initialized from exp7end.             | started 2014-2015 -10
| exp22  | exp06 E4, initialized from exp7end.             | started 2014-2015 -11
| exp23  | exp12 E5, initialized from exp6end.             | PLANNED
| exp24  | exp13 E5, initialized from exp6end.             | PLANNED
| exp25  | exp06 E5, initialized from exp6end.             | PLANNED
** Performance/scaling:
